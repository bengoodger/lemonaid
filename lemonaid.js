...
var lutron = route.addDevice({
  ...
  init : {
    ...
    devices : {
      ...
      "KitchenTable" : { id : 28, type : Lutron.TYPE_LIGHT },
      "OfficeRecessed" : { id : 80, type : Lutron.TYPE_LIGHT },
      "OfficePendant" : { id : 81, type : Lutron.TYPE_LIGHT },
      "LanaiChandeliers" : { id : 17, type : Lutron.TYPE_LIGHT },
      "LanaiKitchen" : { id : 88, type : Lutron.TYPE_LIGHT },
      ...
      "VivianRecessed" : { id : 82, type : Lutron.TYPE_LIGHT },
      "VivianFlushmount" : { id : 83, type : Lutron.TYPE_LIGHT },
      "HallwayBuiltin" : { id : 79, type : Lutron.TYPE_LIGHT },
      "GuestRoomRecessed" : { id : 76, type : Lutron.TYPE_LIGHT },
      "GuestRoomFlushmount" : { id : 77, type : Lutron.TYPE_LIGHT },
      "GuestRoomPorch" : { id : 78, type : Lutron.TYPE_LIGHT },
      "DownstairsHall" : { id : 86, type : Lutron.TYPE_LIGHT },
      "MarissaLamp" : { id : 90, type : Lutron.TYPE_LIGHT },
      "BenLamp" : { id : 89, type : Lutron.TYPE_LIGHT },
      "RumpusRoom" : { id : 69, type : Lutron.TYPE_LIGHT },
      "RumpusRoomPorch" : { id : 68, type : Lutron.TYPE_LIGHT },
